...
void dJydsigmay_SPARCED_IFNg(realtype *dJydsigmay, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my){
    switch(iy) {
        case 0:
        ...
        case 772:
            ...
            break;
        case 773:
            dJydsigmay[773] = 1.0/sigma_yIFR - 1.0*std::pow(-myIFR + yIFR, 2)/std::pow(sigma_yIFR, 3);
            break;
        case 774:
            dJydsigmay[774] = 1.0/sigma_yJAK - 1.0*std::pow(-myJAK + yJAK, 2)/std::pow(sigma_yJAK, 3);
            break;
        case 775:
            dJydsigmay[775] = 1.0/sigma_yRJ - 1.0*std::pow(-myRJ + yRJ, 2)/std::pow(sigma_yRJ, 3);
            break;
        case 776:
            dJydsigmay[776] = 1.0/sigma_yIFNRJ - 1.0*std::pow(-myIFNRJ + yIFNRJ, 2)/std::pow(sigma_yIFNRJ, 3);
            break;
        case 777:
            dJydsigmay[777] = 1.0/sigma_yIFNRJ2 - 1.0*std::pow(-myIFNRJ2 + yIFNRJ2, 2)/std::pow(sigma_yIFNRJ2, 3);
            break;
        case 778:
            dJydsigmay[778] = 1.0/sigma_yIFNRJ2s - 1.0*std::pow(-myIFNRJ2s + yIFNRJ2s, 2)/std::pow(sigma_yIFNRJ2s, 3);
            break;
        case 779:
            dJydsigmay[779] = 1.0/sigma_ySTAT1 - 1.0*std::pow(-mySTAT1 + ySTAT1, 2)/std::pow(sigma_ySTAT1, 3);
            break;
        case 780:
            dJydsigmay[780] = 1.0/sigma_yIFNRJ2s_STAT1 - 1.0*std::pow(-myIFNRJ2s_STAT1 + yIFNRJ2s_STAT1, 2)/std::pow(sigma_yIFNRJ2s_STAT1, 3);
            break;
        case 781:
            dJydsigmay[781] = 1.0/sigma_ySTAT1s - 1.0*std::pow(-mySTAT1s + ySTAT1s, 2)/std::pow(sigma_ySTAT1s, 3);
            break;
        case 782:
            dJydsigmay[782] = 1.0/sigma_yIFNRJ2s_STAT1s - 1.0*std::pow(-myIFNRJ2s_STAT1s + yIFNRJ2s_STAT1s, 2)/std::pow(sigma_yIFNRJ2s_STAT1s, 3);
            break;
        case 783:
            dJydsigmay[783] = 1.0/sigma_ySTAT1s_STAT1s - 1.0*std::pow(-mySTAT1s_STAT1s + ySTAT1s_STAT1s, 2)/std::pow(sigma_ySTAT1s_STAT1s, 3);
            break;
        case 784:
            dJydsigmay[784] = 1.0/sigma_ySHP2 - 1.0*std::pow(-mySHP2 + ySHP2, 2)/std::pow(sigma_ySHP2, 3);
            break;
        case 785:
            dJydsigmay[785] = 1.0/sigma_yIFNRJ2s_SHP2 - 1.0*std::pow(-myIFNRJ2s_SHP2 + yIFNRJ2s_SHP2, 2)/std::pow(sigma_yIFNRJ2s_SHP2, 3);
            break;
        case 786:
            dJydsigmay[786] = 1.0/sigma_yPPX - 1.0*std::pow(-myPPX + yPPX, 2)/std::pow(sigma_yPPX, 3);
            break;
        case 787:
            dJydsigmay[787] = 1.0/sigma_ySTAT1s_PPX - 1.0*std::pow(-mySTAT1s_PPX + ySTAT1s_PPX, 2)/std::pow(sigma_ySTAT1s_PPX, 3);
            break;
        case 788:
            dJydsigmay[788] = 1.0/sigma_ySTAT1_STAT1s - 1.0*std::pow(-mySTAT1_STAT1s + ySTAT1_STAT1s, 2)/std::pow(sigma_ySTAT1_STAT1s, 3);
            break;
        case 789:
            dJydsigmay[789] = 1.0/sigma_ySTAT1snuc_STAT1snuc - 1.0*std::pow(-mySTAT1snuc_STAT1snuc + ySTAT1snuc_STAT1snuc, 2)/std::pow(sigma_ySTAT1snuc_STAT1snuc, 3);
            break;
        case 790:
            dJydsigmay[790] = 1.0/sigma_ySTAT1snuc - 1.0*std::pow(-mySTAT1snuc + ySTAT1snuc, 2)/std::pow(sigma_ySTAT1snuc, 3);
            break;
        case 791:
            dJydsigmay[791] = 1.0/sigma_yPPN - 1.0*std::pow(-myPPN + yPPN, 2)/std::pow(sigma_yPPN, 3);
            break;
        case 792:
            dJydsigmay[792] = 1.0/sigma_ySTAT1snuc_PPN - 1.0*std::pow(-mySTAT1snuc_PPN + ySTAT1snuc_PPN, 2)/std::pow(sigma_ySTAT1snuc_PPN, 3);
            break;
        case 793:
            dJydsigmay[793] = 1.0/sigma_ySTAT1nuc - 1.0*std::pow(-mySTAT1nuc + ySTAT1nuc, 2)/std::pow(sigma_ySTAT1nuc, 3);
            break;
        case 794:
            dJydsigmay[794] = 1.0/sigma_ySTAT1nuc_STAT1snuc - 1.0*std::pow(-mySTAT1nuc_STAT1snuc + ySTAT1nuc_STAT1snuc, 2)/std::pow(sigma_ySTAT1nuc_STAT1snuc, 3);
            break;
        case 795:
            dJydsigmay[795] = 1.0/sigma_ySOCS1 - 1.0*std::pow(-mySOCS1 + ySOCS1, 2)/std::pow(sigma_ySOCS1, 3);
            break;
        case 796:
            dJydsigmay[796] = 1.0/sigma_yIFNRJ2s_SOCS1 - 1.0*std::pow(-myIFNRJ2s_SOCS1 + yIFNRJ2s_SOCS1, 2)/std::pow(sigma_yIFNRJ2s_SOCS1, 3);
            break;
        case 797:
            dJydsigmay[797] = 1.0/sigma_yIFNRJ2s_SHP2_SOCS1_STAT1 - 1.0*std::pow(-myIFNRJ2s_SHP2_SOCS1_STAT1 + yIFNRJ2s_SHP2_SOCS1_STAT1, 2)/std::pow(sigma_yIFNRJ2s_SHP2_SOCS1_STAT1, 3);
            break;
        case 798:
            dJydsigmay[798] = 1.0/sigma_ySTAT1s_STAT1s_PPX - 1.0*std::pow(-mySTAT1s_STAT1s_PPX + ySTAT1s_STAT1s_PPX, 2)/std::pow(sigma_ySTAT1s_STAT1s_PPX, 3);
            break;
        case 799:
            dJydsigmay[799] = 1.0/sigma_ySTAT1snuc_STAT1snuc_PPN - 1.0*std::pow(-mySTAT1snuc_STAT1snuc_PPN + ySTAT1snuc_STAT1snuc_PPN, 2)/std::pow(sigma_ySTAT1snuc_STAT1snuc_PPN, 3);
            break;
        case 800:
            dJydsigmay[800] = 1.0/sigma_yIFNRJ2s_SOCS1_STAT1 - 1.0*std::pow(-myIFNRJ2s_SOCS1_STAT1 + yIFNRJ2s_SOCS1_STAT1, 2)/std::pow(sigma_yIFNRJ2s_SOCS1_STAT1, 3);
            break;
        case 801:
            dJydsigmay[801] = 1.0/sigma_yIFN - 1.0*std::pow(-myIFN + yIFN, 2)/std::pow(sigma_yIFN, 3);
            break;
        case 802:
            dJydsigmay[802] = 1.0/sigma_yIFNRJ2s_SHP2_STAT1 - 1.0*std::pow(-myIFNRJ2s_SHP2_STAT1 + yIFNRJ2s_SHP2_STAT1, 2)/std::pow(sigma_yIFNRJ2s_SHP2_STAT1, 3);
            break;
        case 803:
            dJydsigmay[803] = 1.0/sigma_yIFNRJ2s_SHP2_SOCS1 - 1.0*std::pow(-myIFNRJ2s_SHP2_SOCS1 + yIFNRJ2s_SHP2_SOCS1, 2)/std::pow(sigma_yIFNRJ2s_SHP2_SOCS1, 3);
            break;
        case 804:
            dJydsigmay[804] = 1.0/sigma_yIFNR - 1.0*std::pow(-myIFNR + yIFNR, 2)/std::pow(sigma_yIFNR, 3);
            break;
        case 805:
            dJydsigmay[805] = 1.0/sigma_ym_TP53 - 1.0*std::pow(-mym_TP53 + ym_TP53, 2)/std::pow(sigma_ym_TP53, 3);
            break;
        case 806:
            dJydsigmay[806] = 1.0/sigma_ym_MDM2 - 1.0*std::pow(-mym_MDM2 + ym_MDM2, 2)/std::pow(sigma_ym_MDM2, 3);
            break;
        case 807:
            dJydsigmay[807] = 1.0/sigma_ym_PPM1D - 1.0*std::pow(-mym_PPM1D + ym_PPM1D, 2)/std::pow(sigma_ym_PPM1D, 3);
            break;
        case 808:
            dJydsigmay[808] = 1.0/sigma_ym_ATM - 1.0*std::pow(-mym_ATM + ym_ATM, 2)/std::pow(sigma_ym_ATM, 3);
            break;
        case 809:
            dJydsigmay[809] = 1.0/sigma_ym_ATR - 1.0*std::pow(-mym_ATR + ym_ATR, 2)/std::pow(sigma_ym_ATR, 3);
            break;
        case 810:
            dJydsigmay[810] = 1.0/sigma_ym_RB1 - 1.0*std::pow(-mym_RB1 + ym_RB1, 2)/std::pow(sigma_ym_RB1, 3);
            break;
        case 811:
            dJydsigmay[811] = 1.0/sigma_ym_E2F1 - 1.0*std::pow(-mym_E2F1 + ym_E2F1, 2)/std::pow(sigma_ym_E2F1, 3);
            break;
        case 812:
            dJydsigmay[812] = 1.0/sigma_ym_E2F2 - 1.0*std::pow(-mym_E2F2 + ym_E2F2, 2)/std::pow(sigma_ym_E2F2, 3);
            break;
        case 813:
            dJydsigmay[813] = 1.0/sigma_ym_E2F3 - 1.0*std::pow(-mym_E2F3 + ym_E2F3, 2)/std::pow(sigma_ym_E2F3, 3);
            break;
        case 814:
            dJydsigmay[814] = 1.0/sigma_ym_CCND1 - 1.0*std::pow(-mym_CCND1 + ym_CCND1, 2)/std::pow(sigma_ym_CCND1, 3);
            break;
        case 815:
            dJydsigmay[815] = 1.0/sigma_ym_CCND2 - 1.0*std::pow(-mym_CCND2 + ym_CCND2, 2)/std::pow(sigma_ym_CCND2, 3);
            break;
        case 816:
            dJydsigmay[816] = 1.0/sigma_ym_CCND3 - 1.0*std::pow(-mym_CCND3 + ym_CCND3, 2)/std::pow(sigma_ym_CCND3, 3);
            break;
        case 817:
            dJydsigmay[817] = 1.0/sigma_ym_CCNE1 - 1.0*std::pow(-mym_CCNE1 + ym_CCNE1, 2)/std::pow(sigma_ym_CCNE1, 3);
            break;
        case 818:
            dJydsigmay[818] = 1.0/sigma_ym_CCNE2 - 1.0*std::pow(-mym_CCNE2 + ym_CCNE2, 2)/std::pow(sigma_ym_CCNE2, 3);
            break;
        case 819:
            dJydsigmay[819] = 1.0/sigma_ym_SKP2 - 1.0*std::pow(-mym_SKP2 + ym_SKP2, 2)/std::pow(sigma_ym_SKP2, 3);
            break;
        case 820:
            dJydsigmay[820] = 1.0/sigma_ym_CDC25A - 1.0*std::pow(-mym_CDC25A + ym_CDC25A, 2)/std::pow(sigma_ym_CDC25A, 3);
            break;
        case 821:
            dJydsigmay[821] = 1.0/sigma_ym_CDC25B - 1.0*std::pow(-mym_CDC25B + ym_CDC25B, 2)/std::pow(sigma_ym_CDC25B, 3);
            break;
        case 822:
            dJydsigmay[822] = 1.0/sigma_ym_CDC25C - 1.0*std::pow(-mym_CDC25C + ym_CDC25C, 2)/std::pow(sigma_ym_CDC25C, 3);
            break;
        case 823:
            dJydsigmay[823] = 1.0/sigma_ym_CCNA2 - 1.0*std::pow(-mym_CCNA2 + ym_CCNA2, 2)/std::pow(sigma_ym_CCNA2, 3);
            break;
        case 824:
            dJydsigmay[824] = 1.0/sigma_ym_CDKN1B - 1.0*std::pow(-mym_CDKN1B + ym_CDKN1B, 2)/std::pow(sigma_ym_CDKN1B, 3);
            break;
        case 825:
            dJydsigmay[825] = 1.0/sigma_ym_CDH1 - 1.0*std::pow(-mym_CDH1 + ym_CDH1, 2)/std::pow(sigma_ym_CDH1, 3);
            break;
        case 826:
            dJydsigmay[826] = 1.0/sigma_ym_CCNB1 - 1.0*std::pow(-mym_CCNB1 + ym_CCNB1, 2)/std::pow(sigma_ym_CCNB1, 3);
            break;
        case 827:
            dJydsigmay[827] = 1.0/sigma_ym_CDC20 - 1.0*std::pow(-mym_CDC20 + ym_CDC20, 2)/std::pow(sigma_ym_CDC20, 3);
            break;
        case 828:
            dJydsigmay[828] = 1.0/sigma_ym_WEE1 - 1.0*std::pow(-mym_WEE1 + ym_WEE1, 2)/std::pow(sigma_ym_WEE1, 3);
            break;
        case 829:
            dJydsigmay[829] = 1.0/sigma_ym_CHEK1 - 1.0*std::pow(-mym_CHEK1 + ym_CHEK1, 2)/std::pow(sigma_ym_CHEK1, 3);
            break;
        case 830:
            dJydsigmay[830] = 1.0/sigma_ym_CDKN1A - 1.0*std::pow(-mym_CDKN1A + ym_CDKN1A, 2)/std::pow(sigma_ym_CDKN1A, 3);
            break;
        case 831:
            dJydsigmay[831] = 1.0/sigma_ym_CDK1 - 1.0*std::pow(-mym_CDK1 + ym_CDK1, 2)/std::pow(sigma_ym_CDK1, 3);
            break;
        case 832:
            dJydsigmay[832] = 1.0/sigma_ym_CDK2 - 1.0*std::pow(-mym_CDK2 + ym_CDK2, 2)/std::pow(sigma_ym_CDK2, 3);
            break;
        case 833:
            dJydsigmay[833] = 1.0/sigma_ym_CDK4 - 1.0*std::pow(-mym_CDK4 + ym_CDK4, 2)/std::pow(sigma_ym_CDK4, 3);
            break;
        case 834:
            dJydsigmay[834] = 1.0/sigma_ym_CDK6 - 1.0*std::pow(-mym_CDK6 + ym_CDK6, 2)/std::pow(sigma_ym_CDK6, 3);
            break;
        case 835:
            dJydsigmay[835] = 1.0/sigma_ym_TNFSF10 - 1.0*std::pow(-mym_TNFSF10 + ym_TNFSF10, 2)/std::pow(sigma_ym_TNFSF10, 3);
            break;
        case 836:
            dJydsigmay[836] = 1.0/sigma_ym_TNFRSF10A - 1.0*std::pow(-mym_TNFRSF10A + ym_TNFRSF10A, 2)/std::pow(sigma_ym_TNFRSF10A, 3);
            break;
        case 837:
            dJydsigmay[837] = 1.0/sigma_ym_TNFRSF10B - 1.0*std::pow(-mym_TNFRSF10B + ym_TNFRSF10B, 2)/std::pow(sigma_ym_TNFRSF10B, 3);
            break;
        case 838:
            dJydsigmay[838] = 1.0/sigma_ym_CFLAR - 1.0*std::pow(-mym_CFLAR + ym_CFLAR, 2)/std::pow(sigma_ym_CFLAR, 3);
            break;
        case 839:
            dJydsigmay[839] = 1.0/sigma_ym_CASP8 - 1.0*std::pow(-mym_CASP8 + ym_CASP8, 2)/std::pow(sigma_ym_CASP8, 3);
            break;
        case 840:
            dJydsigmay[840] = 1.0/sigma_ym_CASP10 - 1.0*std::pow(-mym_CASP10 + ym_CASP10, 2)/std::pow(sigma_ym_CASP10, 3);
            break;
        case 841:
            dJydsigmay[841] = 1.0/sigma_ym_BFAR - 1.0*std::pow(-mym_BFAR + ym_BFAR, 2)/std::pow(sigma_ym_BFAR, 3);
            break;
        case 842:
            dJydsigmay[842] = 1.0/sigma_ym_CASP3 - 1.0*std::pow(-mym_CASP3 + ym_CASP3, 2)/std::pow(sigma_ym_CASP3, 3);
            break;
        case 843:
            dJydsigmay[843] = 1.0/sigma_ym_CASP7 - 1.0*std::pow(-mym_CASP7 + ym_CASP7, 2)/std::pow(sigma_ym_CASP7, 3);
            break;
        case 844:
            dJydsigmay[844] = 1.0/sigma_ym_CASP6 - 1.0*std::pow(-mym_CASP6 + ym_CASP6, 2)/std::pow(sigma_ym_CASP6, 3);
            break;
        case 845:
            dJydsigmay[845] = 1.0/sigma_ym_XIAP - 1.0*std::pow(-mym_XIAP + ym_XIAP, 2)/std::pow(sigma_ym_XIAP, 3);
            break;
        case 846:
            dJydsigmay[846] = 1.0/sigma_ym_PARP1 - 1.0*std::pow(-mym_PARP1 + ym_PARP1, 2)/std::pow(sigma_ym_PARP1, 3);
            break;
        case 847:
            dJydsigmay[847] = 1.0/sigma_ym_BID - 1.0*std::pow(-mym_BID + ym_BID, 2)/std::pow(sigma_ym_BID, 3);
            break;
        case 848:
            dJydsigmay[848] = 1.0/sigma_ym_BCL2 - 1.0*std::pow(-mym_BCL2 + ym_BCL2, 2)/std::pow(sigma_ym_BCL2, 3);
            break;
        case 849:
            dJydsigmay[849] = 1.0/sigma_ym_BCL2L1 - 1.0*std::pow(-mym_BCL2L1 + ym_BCL2L1, 2)/std::pow(sigma_ym_BCL2L1, 3);
            break;
        case 850:
            dJydsigmay[850] = 1.0/sigma_ym_MCL1 - 1.0*std::pow(-mym_MCL1 + ym_MCL1, 2)/std::pow(sigma_ym_MCL1, 3);
            break;
        case 851:
            dJydsigmay[851] = 1.0/sigma_ym_BAX - 1.0*std::pow(-mym_BAX + ym_BAX, 2)/std::pow(sigma_ym_BAX, 3);
            break;
        case 852:
            dJydsigmay[852] = 1.0/sigma_ym_CYCS - 1.0*std::pow(-mym_CYCS + ym_CYCS, 2)/std::pow(sigma_ym_CYCS, 3);
            break;
        case 853:
            dJydsigmay[853] = 1.0/sigma_ym_DIABLO - 1.0*std::pow(-mym_DIABLO + ym_DIABLO, 2)/std::pow(sigma_ym_DIABLO, 3);
            break;
        case 854:
            dJydsigmay[854] = 1.0/sigma_ym_APAF1 - 1.0*std::pow(-mym_APAF1 + ym_APAF1, 2)/std::pow(sigma_ym_APAF1, 3);
            break;
        case 855:
            dJydsigmay[855] = 1.0/sigma_ym_CASP9 - 1.0*std::pow(-mym_CASP9 + ym_CASP9, 2)/std::pow(sigma_ym_CASP9, 3);
            break;
        case 856:
            dJydsigmay[856] = 1.0/sigma_ym_BAD - 1.0*std::pow(-mym_BAD + ym_BAD, 2)/std::pow(sigma_ym_BAD, 3);
            break;
        case 857:
            dJydsigmay[857] = 1.0/sigma_ym_BBC3 - 1.0*std::pow(-mym_BBC3 + ym_BBC3, 2)/std::pow(sigma_ym_BBC3, 3);
            break;
        case 858:
            dJydsigmay[858] = 1.0/sigma_ym_PMAIP1 - 1.0*std::pow(-mym_PMAIP1 + ym_PMAIP1, 2)/std::pow(sigma_ym_PMAIP1, 3);
            break;
        case 859:
            dJydsigmay[859] = 1.0/sigma_ym_BCL2L11 - 1.0*std::pow(-mym_BCL2L11 + ym_BCL2L11, 2)/std::pow(sigma_ym_BCL2L11, 3);
            break;
        case 860:
            dJydsigmay[860] = 1.0/sigma_ym_EGF - 1.0*std::pow(-mym_EGF + ym_EGF, 2)/std::pow(sigma_ym_EGF, 3);
            break;
        case 861:
            dJydsigmay[861] = 1.0/sigma_ym_NRG1 - 1.0*std::pow(-mym_NRG1 + ym_NRG1, 2)/std::pow(sigma_ym_NRG1, 3);
            break;
        case 862:
            dJydsigmay[862] = 1.0/sigma_ym_EGFR - 1.0*std::pow(-mym_EGFR + ym_EGFR, 2)/std::pow(sigma_ym_EGFR, 3);
            break;
        case 863:
            dJydsigmay[863] = 1.0/sigma_ym_ERBB2 - 1.0*std::pow(-mym_ERBB2 + ym_ERBB2, 2)/std::pow(sigma_ym_ERBB2, 3);
            break;
        case 864:
            dJydsigmay[864] = 1.0/sigma_ym_ERBB3 - 1.0*std::pow(-mym_ERBB3 + ym_ERBB3, 2)/std::pow(sigma_ym_ERBB3, 3);
            break;
        case 865:
            dJydsigmay[865] = 1.0/sigma_ym_ERBB4 - 1.0*std::pow(-mym_ERBB4 + ym_ERBB4, 2)/std::pow(sigma_ym_ERBB4, 3);
            break;
        case 866:
            dJydsigmay[866] = 1.0/sigma_ym_EGFRvIII - 1.0*std::pow(-mym_EGFRvIII + ym_EGFRvIII, 2)/std::pow(sigma_ym_EGFRvIII, 3);
            break;
        case 867:
            dJydsigmay[867] = 1.0/sigma_ym_MET - 1.0*std::pow(-mym_MET + ym_MET, 2)/std::pow(sigma_ym_MET, 3);
            break;
        case 868:
            dJydsigmay[868] = 1.0/sigma_ym_HGF - 1.0*std::pow(-mym_HGF + ym_HGF, 2)/std::pow(sigma_ym_HGF, 3);
            break;
        case 869:
            dJydsigmay[869] = 1.0/sigma_ym_PDGFRA - 1.0*std::pow(-mym_PDGFRA + ym_PDGFRA, 2)/std::pow(sigma_ym_PDGFRA, 3);
            break;
        case 870:
            dJydsigmay[870] = 1.0/sigma_ym_PDGFRB - 1.0*std::pow(-mym_PDGFRB + ym_PDGFRB, 2)/std::pow(sigma_ym_PDGFRB, 3);
            break;
        case 871:
            dJydsigmay[871] = 1.0/sigma_ym_PDGFB - 1.0*std::pow(-mym_PDGFB + ym_PDGFB, 2)/std::pow(sigma_ym_PDGFB, 3);
            break;
        case 872:
            dJydsigmay[872] = 1.0/sigma_ym_SPRY2 - 1.0*std::pow(-mym_SPRY2 + ym_SPRY2, 2)/std::pow(sigma_ym_SPRY2, 3);
            break;
        case 873:
            dJydsigmay[873] = 1.0/sigma_ym_CBL - 1.0*std::pow(-mym_CBL + ym_CBL, 2)/std::pow(sigma_ym_CBL, 3);
            break;
        case 874:
            dJydsigmay[874] = 1.0/sigma_ym_GRB2 - 1.0*std::pow(-mym_GRB2 + ym_GRB2, 2)/std::pow(sigma_ym_GRB2, 3);
            break;
        case 875:
            dJydsigmay[875] = 1.0/sigma_ym_PLCG1 - 1.0*std::pow(-mym_PLCG1 + ym_PLCG1, 2)/std::pow(sigma_ym_PLCG1, 3);
            break;
        case 876:
            dJydsigmay[876] = 1.0/sigma_ym_PLCG2 - 1.0*std::pow(-mym_PLCG2 + ym_PLCG2, 2)/std::pow(sigma_ym_PLCG2, 3);
            break;
        case 877:
            dJydsigmay[877] = 1.0/sigma_ym_PIK3CA - 1.0*std::pow(-mym_PIK3CA + ym_PIK3CA, 2)/std::pow(sigma_ym_PIK3CA, 3);
            break;
        case 878:
            dJydsigmay[878] = 1.0/sigma_ym_PIK3CB - 1.0*std::pow(-mym_PIK3CB + ym_PIK3CB, 2)/std::pow(sigma_ym_PIK3CB, 3);
            break;
        case 879:
            dJydsigmay[879] = 1.0/sigma_ym_PIK3CG - 1.0*std::pow(-mym_PIK3CG + ym_PIK3CG, 2)/std::pow(sigma_ym_PIK3CG, 3);
            break;
        case 880:
            dJydsigmay[880] = 1.0/sigma_ym_PIK3CD - 1.0*std::pow(-mym_PIK3CD + ym_PIK3CD, 2)/std::pow(sigma_ym_PIK3CD, 3);
            break;
        case 881:
            dJydsigmay[881] = 1.0/sigma_ym_PIK3R1 - 1.0*std::pow(-mym_PIK3R1 + ym_PIK3R1, 2)/std::pow(sigma_ym_PIK3R1, 3);
            break;
        case 882:
            dJydsigmay[882] = 1.0/sigma_ym_PIK3R2 - 1.0*std::pow(-mym_PIK3R2 + ym_PIK3R2, 2)/std::pow(sigma_ym_PIK3R2, 3);
            break;
        case 883:
            dJydsigmay[883] = 1.0/sigma_ym_PIK3R3 - 1.0*std::pow(-mym_PIK3R3 + ym_PIK3R3, 2)/std::pow(sigma_ym_PIK3R3, 3);
            break;
        case 884:
            dJydsigmay[884] = 1.0/sigma_ym_PIK3R4 - 1.0*std::pow(-mym_PIK3R4 + ym_PIK3R4, 2)/std::pow(sigma_ym_PIK3R4, 3);
            break;
        case 885:
            dJydsigmay[885] = 1.0/sigma_ym_PIK3C2A - 1.0*std::pow(-mym_PIK3C2A + ym_PIK3C2A, 2)/std::pow(sigma_ym_PIK3C2A, 3);
            break;
        case 886:
            dJydsigmay[886] = 1.0/sigma_ym_RASGRP1 - 1.0*std::pow(-mym_RASGRP1 + ym_RASGRP1, 2)/std::pow(sigma_ym_RASGRP1, 3);
            break;
        case 887:
            dJydsigmay[887] = 1.0/sigma_ym_RASGRP3 - 1.0*std::pow(-mym_RASGRP3 + ym_RASGRP3, 2)/std::pow(sigma_ym_RASGRP3, 3);
            break;
        case 888:
            dJydsigmay[888] = 1.0/sigma_ym_NRAS - 1.0*std::pow(-mym_NRAS + ym_NRAS, 2)/std::pow(sigma_ym_NRAS, 3);
            break;
        case 889:
            dJydsigmay[889] = 1.0/sigma_ym_KRAS - 1.0*std::pow(-mym_KRAS + ym_KRAS, 2)/std::pow(sigma_ym_KRAS, 3);
            break;
        case 890:
            dJydsigmay[890] = 1.0/sigma_ym_HRAS - 1.0*std::pow(-mym_HRAS + ym_HRAS, 2)/std::pow(sigma_ym_HRAS, 3);
            break;
        case 891:
            dJydsigmay[891] = 1.0/sigma_ym_NF1 - 1.0*std::pow(-mym_NF1 + ym_NF1, 2)/std::pow(sigma_ym_NF1, 3);
            break;
        case 892:
            dJydsigmay[892] = 1.0/sigma_ym_RAF1 - 1.0*std::pow(-mym_RAF1 + ym_RAF1, 2)/std::pow(sigma_ym_RAF1, 3);
            break;
        case 893:
            dJydsigmay[893] = 1.0/sigma_ym_BRAF - 1.0*std::pow(-mym_BRAF + ym_BRAF, 2)/std::pow(sigma_ym_BRAF, 3);
            break;
        case 894:
            dJydsigmay[894] = 1.0/sigma_ym_MAP2K1 - 1.0*std::pow(-mym_MAP2K1 + ym_MAP2K1, 2)/std::pow(sigma_ym_MAP2K1, 3);
            break;
        case 895:
            dJydsigmay[895] = 1.0/sigma_ym_MAP2K2 - 1.0*std::pow(-mym_MAP2K2 + ym_MAP2K2, 2)/std::pow(sigma_ym_MAP2K2, 3);
            break;
        case 896:
            dJydsigmay[896] = 1.0/sigma_ym_DUSP6 - 1.0*std::pow(-mym_DUSP6 + ym_DUSP6, 2)/std::pow(sigma_ym_DUSP6, 3);
            break;
        case 897:
            dJydsigmay[897] = 1.0/sigma_ym_RPS6KA1 - 1.0*std::pow(-mym_RPS6KA1 + ym_RPS6KA1, 2)/std::pow(sigma_ym_RPS6KA1, 3);
            break;
        case 898:
            dJydsigmay[898] = 1.0/sigma_ym_RPS6KA2 - 1.0*std::pow(-mym_RPS6KA2 + ym_RPS6KA2, 2)/std::pow(sigma_ym_RPS6KA2, 3);
            break;
        case 899:
            dJydsigmay[899] = 1.0/sigma_ym_RPS6KA3 - 1.0*std::pow(-mym_RPS6KA3 + ym_RPS6KA3, 2)/std::pow(sigma_ym_RPS6KA3, 3);
            break;
        case 900:
            dJydsigmay[900] = 1.0/sigma_ym_RPS6KA4 - 1.0*std::pow(-mym_RPS6KA4 + ym_RPS6KA4, 2)/std::pow(sigma_ym_RPS6KA4, 3);
            break;
        case 901:
            dJydsigmay[901] = 1.0/sigma_ym_DUSP1 - 1.0*std::pow(-mym_DUSP1 + ym_DUSP1, 2)/std::pow(sigma_ym_DUSP1, 3);
            break;
        case 902:
            dJydsigmay[902] = 1.0/sigma_ym_FOS - 1.0*std::pow(-mym_FOS + ym_FOS, 2)/std::pow(sigma_ym_FOS, 3);
            break;
        case 903:
            dJydsigmay[903] = 1.0/sigma_ym_JUN - 1.0*std::pow(-mym_JUN + ym_JUN, 2)/std::pow(sigma_ym_JUN, 3);
            break;
        case 904:
            dJydsigmay[904] = 1.0/sigma_ym_MYC - 1.0*std::pow(-mym_MYC + ym_MYC, 2)/std::pow(sigma_ym_MYC, 3);
            break;
        case 905:
            dJydsigmay[905] = 1.0/sigma_ym_CTNNB1 - 1.0*std::pow(-mym_CTNNB1 + ym_CTNNB1, 2)/std::pow(sigma_ym_CTNNB1, 3);
            break;
        case 906:
            dJydsigmay[906] = 1.0/sigma_ym_PTEN - 1.0*std::pow(-mym_PTEN + ym_PTEN, 2)/std::pow(sigma_ym_PTEN, 3);
            break;
        case 907:
            dJydsigmay[907] = 1.0/sigma_ym_AKT1 - 1.0*std::pow(-mym_AKT1 + ym_AKT1, 2)/std::pow(sigma_ym_AKT1, 3);
            break;
        case 908:
            dJydsigmay[908] = 1.0/sigma_ym_AKT2 - 1.0*std::pow(-mym_AKT2 + ym_AKT2, 2)/std::pow(sigma_ym_AKT2, 3);
            break;
        case 909:
            dJydsigmay[909] = 1.0/sigma_ym_PDPK1 - 1.0*std::pow(-mym_PDPK1 + ym_PDPK1, 2)/std::pow(sigma_ym_PDPK1, 3);
            break;
        case 910:
            dJydsigmay[910] = 1.0/sigma_ym_RICTOR - 1.0*std::pow(-mym_RICTOR + ym_RICTOR, 2)/std::pow(sigma_ym_RICTOR, 3);
            break;
        case 911:
            dJydsigmay[911] = 1.0/sigma_ym_MTOR - 1.0*std::pow(-mym_MTOR + ym_MTOR, 2)/std::pow(sigma_ym_MTOR, 3);
            break;
        case 912:
            dJydsigmay[912] = 1.0/sigma_ym_GSK3B - 1.0*std::pow(-mym_GSK3B + ym_GSK3B, 2)/std::pow(sigma_ym_GSK3B, 3);
            break;
        case 913:
            dJydsigmay[913] = 1.0/sigma_ym_TSC1 - 1.0*std::pow(-mym_TSC1 + ym_TSC1, 2)/std::pow(sigma_ym_TSC1, 3);
            break;
        case 914:
            dJydsigmay[914] = 1.0/sigma_ym_TSC2 - 1.0*std::pow(-mym_TSC2 + ym_TSC2, 2)/std::pow(sigma_ym_TSC2, 3);
            break;
        case 915:
            dJydsigmay[915] = 1.0/sigma_ym_PRKCA - 1.0*std::pow(-mym_PRKCA + ym_PRKCA, 2)/std::pow(sigma_ym_PRKCA, 3);
            break;
        case 916:
            dJydsigmay[916] = 1.0/sigma_ym_PRKCB - 1.0*std::pow(-mym_PRKCB + ym_PRKCB, 2)/std::pow(sigma_ym_PRKCB, 3);
            break;
        case 917:
            dJydsigmay[917] = 1.0/sigma_ym_PRKCG - 1.0*std::pow(-mym_PRKCG + ym_PRKCG, 2)/std::pow(sigma_ym_PRKCG, 3);
            break;
        case 918:
            dJydsigmay[918] = 1.0/sigma_ym_PRKCD - 1.0*std::pow(-mym_PRKCD + ym_PRKCD, 2)/std::pow(sigma_ym_PRKCD, 3);
            break;
        case 919:
            dJydsigmay[919] = 1.0/sigma_ym_PEBP1 - 1.0*std::pow(-mym_PEBP1 + ym_PEBP1, 2)/std::pow(sigma_ym_PEBP1, 3);
            break;
        case 920:
            dJydsigmay[920] = 1.0/sigma_ym_MAPK1 - 1.0*std::pow(-mym_MAPK1 + ym_MAPK1, 2)/std::pow(sigma_ym_MAPK1, 3);
            break;
        case 921:
            dJydsigmay[921] = 1.0/sigma_ym_MAPK3 - 1.0*std::pow(-mym_MAPK3 + ym_MAPK3, 2)/std::pow(sigma_ym_MAPK3, 3);
            break;
        case 922:
            dJydsigmay[922] = 1.0/sigma_ym_FOXO3 - 1.0*std::pow(-mym_FOXO3 + ym_FOXO3, 2)/std::pow(sigma_ym_FOXO3, 3);
            break;
        case 923:
            dJydsigmay[923] = 1.0/sigma_ym_RHEB - 1.0*std::pow(-mym_RHEB + ym_RHEB, 2)/std::pow(sigma_ym_RHEB, 3);
            break;
        case 924:
            dJydsigmay[924] = 1.0/sigma_ym_RPTOR - 1.0*std::pow(-mym_RPTOR + ym_RPTOR, 2)/std::pow(sigma_ym_RPTOR, 3);
            break;
        case 925:
            dJydsigmay[925] = 1.0/sigma_ym_RPS6KB1 - 1.0*std::pow(-mym_RPS6KB1 + ym_RPS6KB1, 2)/std::pow(sigma_ym_RPS6KB1, 3);
            break;
        case 926:
            dJydsigmay[926] = 1.0/sigma_ym_RPS6KB2 - 1.0*std::pow(-mym_RPS6KB2 + ym_RPS6KB2, 2)/std::pow(sigma_ym_RPS6KB2, 3);
            break;
        case 927:
            dJydsigmay[927] = 1.0/sigma_ym_EIF4EBP1 - 1.0*std::pow(-mym_EIF4EBP1 + ym_EIF4EBP1, 2)/std::pow(sigma_ym_EIF4EBP1, 3);
            break;
        case 928:
            dJydsigmay[928] = 1.0/sigma_ym_SOS1 - 1.0*std::pow(-mym_SOS1 + ym_SOS1, 2)/std::pow(sigma_ym_SOS1, 3);
            break;
        case 929:
            dJydsigmay[929] = 1.0/sigma_ym_CDKN2A - 1.0*std::pow(-mym_CDKN2A + ym_CDKN2A, 2)/std::pow(sigma_ym_CDKN2A, 3);
            break;
        case 930:
            dJydsigmay[930] = 1.0/sigma_ym_MDM4 - 1.0*std::pow(-mym_MDM4 + ym_MDM4, 2)/std::pow(sigma_ym_MDM4, 3);
            break;
        case 931:
            dJydsigmay[931] = 1.0/sigma_ym_FGFR1 - 1.0*std::pow(-mym_FGFR1 + ym_FGFR1, 2)/std::pow(sigma_ym_FGFR1, 3);
            break;
        case 932:
            dJydsigmay[932] = 1.0/sigma_ym_FGFR2 - 1.0*std::pow(-mym_FGFR2 + ym_FGFR2, 2)/std::pow(sigma_ym_FGFR2, 3);
            break;
        case 933:
            dJydsigmay[933] = 1.0/sigma_ym_FGF1 - 1.0*std::pow(-mym_FGF1 + ym_FGF1, 2)/std::pow(sigma_ym_FGF1, 3);
            break;
        case 934:
            dJydsigmay[934] = 1.0/sigma_ym_FGF2 - 1.0*std::pow(-mym_FGF2 + ym_FGF2, 2)/std::pow(sigma_ym_FGF2, 3);
            break;
        case 935:
            dJydsigmay[935] = 1.0/sigma_ym_EIF4E - 1.0*std::pow(-mym_EIF4E + ym_EIF4E, 2)/std::pow(sigma_ym_EIF4E, 3);
            break;
        case 936:
            dJydsigmay[936] = 1.0/sigma_ym_IRS1 - 1.0*std::pow(-mym_IRS1 + ym_IRS1, 2)/std::pow(sigma_ym_IRS1, 3);
            break;
        case 937:
            dJydsigmay[937] = 1.0/sigma_ym_IRS2 - 1.0*std::pow(-mym_IRS2 + ym_IRS2, 2)/std::pow(sigma_ym_IRS2, 3);
            break;
        case 938:
            dJydsigmay[938] = 1.0/sigma_ym_IGF1 - 1.0*std::pow(-mym_IGF1 + ym_IGF1, 2)/std::pow(sigma_ym_IGF1, 3);
            break;
        case 939:
            dJydsigmay[939] = 1.0/sigma_ym_IGF2 - 1.0*std::pow(-mym_IGF2 + ym_IGF2, 2)/std::pow(sigma_ym_IGF2, 3);
            break;
        case 940:
            dJydsigmay[940] = 1.0/sigma_ym_IGF1R - 1.0*std::pow(-mym_IGF1R + ym_IGF1R, 2)/std::pow(sigma_ym_IGF1R, 3);
            break;
        case 941:
            dJydsigmay[941] = 1.0/sigma_ym_MSH6 - 1.0*std::pow(-mym_MSH6 + ym_MSH6, 2)/std::pow(sigma_ym_MSH6, 3);
            break;
        case 942:
            dJydsigmay[942] = 1.0/sigma_ym_BRCA2 - 1.0*std::pow(-mym_BRCA2 + ym_BRCA2, 2)/std::pow(sigma_ym_BRCA2, 3);
            break;
        case 943:
            dJydsigmay[943] = 1.0/sigma_ym_MGMT - 1.0*std::pow(-mym_MGMT + ym_MGMT, 2)/std::pow(sigma_ym_MGMT, 3);
            break;
        case 944:
            dJydsigmay[944] = 1.0/sigma_ym_INSR - 1.0*std::pow(-mym_INSR + ym_INSR, 2)/std::pow(sigma_ym_INSR, 3);
            break;
        case 945:
            dJydsigmay[945] = 1.0/sigma_ym_INS - 1.0*std::pow(-mym_INS + ym_INS, 2)/std::pow(sigma_ym_INS, 3);
            break;
        case 946:
            dJydsigmay[946] = 1.0/sigma_ym_IFNG - 1.0*std::pow(-mym_IFNG + ym_IFNG, 2)/std::pow(sigma_ym_IFNG, 3);
            break;
        case 947:
            dJydsigmay[947] = 1.0/sigma_ym_IFR - 1.0*std::pow(-mym_IFR + ym_IFR, 2)/std::pow(sigma_ym_IFR, 3);
            break;
        case 948:
            dJydsigmay[948] = 1.0/sigma_ym_JAK - 1.0*std::pow(-mym_JAK + ym_JAK, 2)/std::pow(sigma_ym_JAK, 3);
            break;
        case 949:
            dJydsigmay[949] = 1.0/sigma_ym_STAT1 - 1.0*std::pow(-mym_STAT1 + ym_STAT1, 2)/std::pow(sigma_ym_STAT1, 3);
            break;
        case 950:
            dJydsigmay[950] = 1.0/sigma_ym_SHP2 - 1.0*std::pow(-mym_SHP2 + ym_SHP2, 2)/std::pow(sigma_ym_SHP2, 3);
            break;
        case 951:
            dJydsigmay[951] = 1.0/sigma_ym_PPN - 1.0*std::pow(-mym_PPN + ym_PPN, 2)/std::pow(sigma_ym_PPN, 3);
            break;
        case 952:
            dJydsigmay[952] = 1.0/sigma_ym_PPX - 1.0*std::pow(-mym_PPX + ym_PPX, 2)/std::pow(sigma_ym_PPX, 3);
            break;
        case 953:
            dJydsigmay[953] = 1.0/sigma_ym_SOCS1 - 1.0*std::pow(-mym_SOCS1 + ym_SOCS1, 2)/std::pow(sigma_ym_SOCS1, 3);
            break;
        case 954:
            dJydsigmay[954] = 1.0/sigma_yCytoplasm - 1.0*std::pow(-myCytoplasm + yCytoplasm, 2)/std::pow(sigma_yCytoplasm, 3);
            break;
        case 955:
            dJydsigmay[955] = 1.0/sigma_yExtracellular - 1.0*std::pow(-myExtracellular + yExtracellular, 2)/std::pow(sigma_yExtracellular, 3);
            break;
        case 956:
            dJydsigmay[956] = 1.0/sigma_yNucleus - 1.0*std::pow(-myNucleus + yNucleus, 2)/std::pow(sigma_yNucleus, 3);
            break;
        case 957:
            dJydsigmay[957] = 1.0/sigma_yMitochondrion - 1.0*std::pow(-myMitochondrion + yMitochondrion, 2)/std::pow(sigma_yMitochondrion, 3);
            break;
    }
}
