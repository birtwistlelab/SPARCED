...
void x_solver_BigModel_FULL_v4(realtype *x_solver, const realtype *x_rdata){
    x_solver[0] = Ribosome;
    x_solver[1] = p53inac;
    x_solver[2] = p53ac;
    x_solver[3] = MDM2;
    ...
    x_solver[747] = bCATENIN_GSK3b;
    x_solver[748] = TSC2_ppAKT;
    x_solver[749] = TSC2_ppERK;
    x_solver[750] = RhebT_TSC;
    x_solver[751] = EIF4EBP1_mTORC1active;
    x_solver[752] = S6K_mTORC1active;
    x_solver[753] = FOXO_ppAKT;
    x_solver[754] = PI3K1_mTORC1active;
    x_solver[755] = pERK_MKP3;
    x_solver[756] = ppERK_MKP3;
    x_solver[757] = ppERKnuc_pMKP1;
    x_solver[758] = RasT_BRaf;
    x_solver[759] = RasT_BRaf_BRaf;
    x_solver[760] = MEK_RasT_BRaf_BRaf;
    x_solver[761] = pMEK_RasT_BRaf_BRaf;
    x_solver[762] = EIF4E;
    x_solver[763] = EIF4EBP1_EIF4E;
    x_solver[764] = RasT_CRaf_CRaf;
    x_solver[765] = MEK_RasT_CRaf_CRaf;
    x_solver[766] = pMEK_RasT_CRaf_CRaf;
    x_solver[767] = FOXOnuc;
    x_solver[768] = MEKi;
    x_solver[769] = MEKi_ppMEK;
    x_solver[770] = AKTi;
    x_solver[771] = AKTi_AKT;
    x_solver[772] = mT;
    x_solver[773] = EIF4E_mT;
}