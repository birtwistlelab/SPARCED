...
1. Starting the workflow: 
    - `nextflow kuberun ebenz99/SPARCED-nf -v <PVC-name> -c configs/kube-nextflow.config`
2. Retrieving data
...
3. Once the download is complete, use `docker run -p 8888:8888 --name testnb1 -i -t ebensma/sparced-notebook:latest`, and in your browser, got to the last URL produced in your terminal from this command
