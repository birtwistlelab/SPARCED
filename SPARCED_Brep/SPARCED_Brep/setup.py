...
# Build shared object
model_module = Extension('SPARCED_Brep._SPARCED_Brep',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'SPARCED_Brep',
...
setup(
    name='SPARCED_Brep',
    version='0.1.0',
    description='AMICI-generated module for model SPARCED_Brep',
    ...
    install_requires=['amici==0.10.13'],
