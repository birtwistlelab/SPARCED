...
for cell in range(cellpop_g1):
    ...
    if len(cb_peaks)>0:
        ...
        if ~np.isnan(dp):
        # th_g2_cell = tout_all[plateaus[2,0]]/3600
            th_g2_cell = tout_all[dp]/3600
            
            # sp_g2_cell = xoutS_all[plateaus[2,0]]
...
while cellpop_gn0 > 0:
    ...
    for cell_n in range(cellpop_gn0):
        ...
        if len(cb_peaks_n > 0):
            ...
            # th_g2_n = tout_all[plateaus[2,0]]/3600
            dp = find_dp(xoutS_all,tout_all)
            ...
            if ~np.isnan(dp):
                ...
                # sp_g2_n = xoutS_all[plateaus[2,0]]
