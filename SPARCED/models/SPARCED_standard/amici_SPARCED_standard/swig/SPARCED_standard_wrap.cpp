...
#define SWIGTYPE_p_std__functionT_void_fstd__string_const_R_std__string_const_RF_t swig_types[9]
...
/*-----------------------------------------------
              @(target):= _SPARCED_standard.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__SPARCED_standard

#else
#  define SWIG_init    init_SPARCED_standard

#endif
#define SWIG_name    "_SPARCED_standard"
