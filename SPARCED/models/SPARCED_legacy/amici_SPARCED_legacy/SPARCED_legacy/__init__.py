"""AMICI-generated module for model SPARCED_legacy"""

import amici

# Ensure we are binary-compatible, see #556
if '0.11.12' != amici.__version__:
    raise RuntimeError('Cannot use model SPARCED_legacy, generated with AMICI '
...
from SPARCED_legacy._SPARCED_legacy import *
