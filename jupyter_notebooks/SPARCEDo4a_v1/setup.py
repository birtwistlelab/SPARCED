...
def get_extension() -> Extension:
    ...
    sources = [os.path.join("swig", "SPARCEDo4a_v1.i"), *get_model_sources()]
    ...
    # Build shared object
    ext = Extension(
        'SPARCEDo4a_v1._SPARCEDo4a_v1',
        sources=sources,
        include_dirs=ext_include_dirs,
        libraries=libraries,
        library_dirs=ext_library_dirs,
        swig_opts=[
            '-c++', '-modern', '-outdir', 'SPARCEDo4a_v1',
...
setup(
    ...
    cmdclass=CMDCLASS,
    version='0.1.0',
    description='AMICI-generated module for model SPARCEDo4a_v1',
    ...
    install_requires=['amici==0.11.16'],
