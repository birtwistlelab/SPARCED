...
#include "SPARCED_u87i_dJydy.h"

namespace amici {
namespace model_SPARCED_u87i {

void dJydy_SPARCED_u87i(realtype *dJydy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my){
    switch(iy) {
        case 0:
