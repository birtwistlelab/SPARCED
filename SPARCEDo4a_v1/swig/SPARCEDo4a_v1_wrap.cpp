...
#define SWIGTYPE_p_user_data_type swig_types[12]
...
/*-----------------------------------------------
              @(target):= _SPARCEDo4a_v1.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__SPARCEDo4a_v1

#else
#  define SWIG_init    init_SPARCEDo4a_v1

#endif
#define SWIG_name    "_SPARCEDo4a_v1"
