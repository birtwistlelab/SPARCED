...
sources = ['swig/BigModel_FULL_v4.i', *getModelSources()]
...
# Build shared object
model_module = Extension('BigModel_FULL_v4._BigModel_FULL_v4',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'BigModel_FULL_v4',
...
# Install
setup(
    name='BigModel_FULL_v4',
    version='0.1.0',
    description='AMICI-generated module for model BigModel_FULL_v4',
    ...
    install_requires=['amici==0.10.12'],
