...
#include "SPARCED_10ai_dwdw.h"

namespace amici {
namespace model_SPARCED_10ai {

void dwdw_SPARCED_10ai(realtype *dwdw, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl){
