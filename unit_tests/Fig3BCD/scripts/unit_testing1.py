...
def sparced_erm(yaml_file, flagD: Optional[int] = None):
        ...
        simulation_time = measurement_df['time'].max()/60
        ...
        for index, condition in unique_conditions.iterrows(): # Iterate through the unique conditions
            ...
            xoutS_all, xoutG_all, tout_all = RunSPARCED(1,simulation_time,species_initializations,[],sbml_file,model)
