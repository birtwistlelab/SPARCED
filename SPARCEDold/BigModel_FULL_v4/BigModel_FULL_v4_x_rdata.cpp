...
void x_rdata_BigModel_FULL_v4(realtype *x_rdata, const realtype *x, const realtype *tcl){
    x_rdata[0] = Ribosome;
    x_rdata[1] = p53inac;
    x_rdata[2] = p53ac;
    x_rdata[3] = MDM2;
    ...
    x_rdata[747] = bCATENIN_GSK3b;
    x_rdata[748] = TSC2_ppAKT;
    x_rdata[749] = TSC2_ppERK;
    x_rdata[750] = RhebT_TSC;
    x_rdata[751] = EIF4EBP1_mTORC1active;
    x_rdata[752] = S6K_mTORC1active;
    x_rdata[753] = FOXO_ppAKT;
    x_rdata[754] = PI3K1_mTORC1active;
    x_rdata[755] = pERK_MKP3;
    x_rdata[756] = ppERK_MKP3;
    x_rdata[757] = ppERKnuc_pMKP1;
    x_rdata[758] = RasT_BRaf;
    x_rdata[759] = RasT_BRaf_BRaf;
    x_rdata[760] = MEK_RasT_BRaf_BRaf;
    x_rdata[761] = pMEK_RasT_BRaf_BRaf;
    x_rdata[762] = EIF4E;
    x_rdata[763] = EIF4EBP1_EIF4E;
    x_rdata[764] = RasT_CRaf_CRaf;
    x_rdata[765] = MEK_RasT_CRaf_CRaf;
    x_rdata[766] = pMEK_RasT_CRaf_CRaf;
    x_rdata[767] = FOXOnuc;
    x_rdata[768] = MEKi;
    x_rdata[769] = MEKi_ppMEK;
    x_rdata[770] = AKTi;
    x_rdata[771] = AKTi_AKT;
    x_rdata[772] = mT;
    x_rdata[773] = EIF4E_mT;
}