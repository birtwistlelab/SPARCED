...
#include "SPARCED_au565_y.h"
#include "SPARCED_au565_sigmay.h"
#include "SPARCED_au565_my.h"
#include "SPARCED_au565_dJydy.h"

namespace amici {
namespace model_SPARCED_au565 {

void dJydy_SPARCED_au565(realtype *dJydy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my){
    switch(iy) {
        case 0:
