...
#include "SPARCED_au565_dwdw.h"

namespace amici {
namespace model_SPARCED_au565 {

void dwdw_SPARCED_au565(realtype *dwdw, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl){
