...
void dwdw_SPARCED_IFNg(realtype *dwdw, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl){
    ...
    dflux_r2500_dm_IFNG = 5.2499999999999996e-12*EIF4E*k2505_1/(EIF4E + k2505_2);  // dwdw[137]
    dflux_r2501_dm_IFR = 5.2499999999999996e-12*EIF4E*k2506_1/(EIF4E + k2506_2);  // dwdw[138]
    dflux_r2502_dm_JAK = 5.2499999999999996e-12*EIF4E*k2507_1/(EIF4E + k2507_2);  // dwdw[139]
    dflux_r2503_dm_STAT1 = 5.2499999999999996e-12*EIF4E*k2508_1/(EIF4E + k2508_2);  // dwdw[140]
    dflux_r2504_dm_SHP2 = 5.2499999999999996e-12*EIF4E*k2509_1/(EIF4E + k2509_2);  // dwdw[141]
    dflux_r2505_dm_PPN = 1.75e-12*EIF4E*k2510_1/(EIF4E + k2510_2);  // dwdw[142]
    dflux_r2506_dm_PPX = 5.2499999999999996e-12*EIF4E*k2511_1/(EIF4E + k2511_2);  // dwdw[143]
    dflux_r2507_dm_SOCS1 = 5.2499999999999996e-12*EIF4E*k2512_1/(EIF4E + k2512_2);  // dwdw[144]
}
