...
def get_extension() -> Extension:
    ...
    sources = [os.path.join("swig", "SPARCED_tutorial.i"), *get_model_sources()]
    ...
    # Build shared object
    ext = Extension(
        'SPARCED_tutorial._SPARCED_tutorial',
        sources=sources,
        include_dirs=ext_include_dirs,
        libraries=libraries,
        library_dirs=ext_library_dirs,
        swig_opts=[
            '-c++', '-modern', '-outdir', 'SPARCED_tutorial',
...
# Install
setup(
    name='SPARCED_tutorial',
    cmdclass=CMDCLASS,
    version='0.1.0',
    description='AMICI-generated module for model SPARCED_tutorial',
