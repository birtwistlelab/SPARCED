...
void dJydy_SPARCED_IFNg(realtype *dJydy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my){
    switch(iy) {
        case 0:
        ...
        case 772:
            ...
            break;
        case 773:
            dJydy[0] = (-1.0*myIFR + 1.0*yIFR)/std::pow(sigma_yIFR, 2);
            break;
        case 774:
            dJydy[0] = (-1.0*myJAK + 1.0*yJAK)/std::pow(sigma_yJAK, 2);
            break;
        case 775:
            dJydy[0] = (-1.0*myRJ + 1.0*yRJ)/std::pow(sigma_yRJ, 2);
            break;
        case 776:
            dJydy[0] = (-1.0*myIFNRJ + 1.0*yIFNRJ)/std::pow(sigma_yIFNRJ, 2);
            break;
        case 777:
            dJydy[0] = (-1.0*myIFNRJ2 + 1.0*yIFNRJ2)/std::pow(sigma_yIFNRJ2, 2);
            break;
        case 778:
            dJydy[0] = (-1.0*myIFNRJ2s + 1.0*yIFNRJ2s)/std::pow(sigma_yIFNRJ2s, 2);
            break;
        case 779:
            dJydy[0] = (-1.0*mySTAT1 + 1.0*ySTAT1)/std::pow(sigma_ySTAT1, 2);
            break;
        case 780:
            dJydy[0] = (-1.0*myIFNRJ2s_STAT1 + 1.0*yIFNRJ2s_STAT1)/std::pow(sigma_yIFNRJ2s_STAT1, 2);
            break;
        case 781:
            dJydy[0] = (-1.0*mySTAT1s + 1.0*ySTAT1s)/std::pow(sigma_ySTAT1s, 2);
            break;
        case 782:
            dJydy[0] = (-1.0*myIFNRJ2s_STAT1s + 1.0*yIFNRJ2s_STAT1s)/std::pow(sigma_yIFNRJ2s_STAT1s, 2);
            break;
        case 783:
            dJydy[0] = (-1.0*mySTAT1s_STAT1s + 1.0*ySTAT1s_STAT1s)/std::pow(sigma_ySTAT1s_STAT1s, 2);
            break;
        case 784:
            dJydy[0] = (-1.0*mySHP2 + 1.0*ySHP2)/std::pow(sigma_ySHP2, 2);
            break;
        case 785:
            dJydy[0] = (-1.0*myIFNRJ2s_SHP2 + 1.0*yIFNRJ2s_SHP2)/std::pow(sigma_yIFNRJ2s_SHP2, 2);
            break;
        case 786:
            dJydy[0] = (-1.0*myPPX + 1.0*yPPX)/std::pow(sigma_yPPX, 2);
            break;
        case 787:
            dJydy[0] = (-1.0*mySTAT1s_PPX + 1.0*ySTAT1s_PPX)/std::pow(sigma_ySTAT1s_PPX, 2);
            break;
        case 788:
            dJydy[0] = (-1.0*mySTAT1_STAT1s + 1.0*ySTAT1_STAT1s)/std::pow(sigma_ySTAT1_STAT1s, 2);
            break;
        case 789:
            dJydy[0] = (-1.0*mySTAT1snuc_STAT1snuc + 1.0*ySTAT1snuc_STAT1snuc)/std::pow(sigma_ySTAT1snuc_STAT1snuc, 2);
            break;
        case 790:
            dJydy[0] = (-1.0*mySTAT1snuc + 1.0*ySTAT1snuc)/std::pow(sigma_ySTAT1snuc, 2);
            break;
        case 791:
            dJydy[0] = (-1.0*myPPN + 1.0*yPPN)/std::pow(sigma_yPPN, 2);
            break;
        case 792:
            dJydy[0] = (-1.0*mySTAT1snuc_PPN + 1.0*ySTAT1snuc_PPN)/std::pow(sigma_ySTAT1snuc_PPN, 2);
            break;
        case 793:
            dJydy[0] = (-1.0*mySTAT1nuc + 1.0*ySTAT1nuc)/std::pow(sigma_ySTAT1nuc, 2);
            break;
        case 794:
            dJydy[0] = (-1.0*mySTAT1nuc_STAT1snuc + 1.0*ySTAT1nuc_STAT1snuc)/std::pow(sigma_ySTAT1nuc_STAT1snuc, 2);
            break;
        case 795:
            dJydy[0] = (-1.0*mySOCS1 + 1.0*ySOCS1)/std::pow(sigma_ySOCS1, 2);
            break;
        case 796:
            dJydy[0] = (-1.0*myIFNRJ2s_SOCS1 + 1.0*yIFNRJ2s_SOCS1)/std::pow(sigma_yIFNRJ2s_SOCS1, 2);
            break;
        case 797:
            dJydy[0] = (-1.0*myIFNRJ2s_SHP2_SOCS1_STAT1 + 1.0*yIFNRJ2s_SHP2_SOCS1_STAT1)/std::pow(sigma_yIFNRJ2s_SHP2_SOCS1_STAT1, 2);
            break;
        case 798:
            dJydy[0] = (-1.0*mySTAT1s_STAT1s_PPX + 1.0*ySTAT1s_STAT1s_PPX)/std::pow(sigma_ySTAT1s_STAT1s_PPX, 2);
            break;
        case 799:
            dJydy[0] = (-1.0*mySTAT1snuc_STAT1snuc_PPN + 1.0*ySTAT1snuc_STAT1snuc_PPN)/std::pow(sigma_ySTAT1snuc_STAT1snuc_PPN, 2);
            break;
        case 800:
            dJydy[0] = (-1.0*myIFNRJ2s_SOCS1_STAT1 + 1.0*yIFNRJ2s_SOCS1_STAT1)/std::pow(sigma_yIFNRJ2s_SOCS1_STAT1, 2);
            break;
        case 801:
            dJydy[0] = (-1.0*myIFN + 1.0*yIFN)/std::pow(sigma_yIFN, 2);
            break;
        case 802:
            dJydy[0] = (-1.0*myIFNRJ2s_SHP2_STAT1 + 1.0*yIFNRJ2s_SHP2_STAT1)/std::pow(sigma_yIFNRJ2s_SHP2_STAT1, 2);
            break;
        case 803:
            dJydy[0] = (-1.0*myIFNRJ2s_SHP2_SOCS1 + 1.0*yIFNRJ2s_SHP2_SOCS1)/std::pow(sigma_yIFNRJ2s_SHP2_SOCS1, 2);
            break;
        case 804:
            dJydy[0] = (-1.0*myIFNR + 1.0*yIFNR)/std::pow(sigma_yIFNR, 2);
            break;
        case 805:
        ...
        case 945:
            ...
            break;
        case 946:
            dJydy[0] = (-1.0*mym_IFNG + 1.0*ym_IFNG)/std::pow(sigma_ym_IFNG, 2);
            break;
        case 947:
            dJydy[0] = (-1.0*mym_IFR + 1.0*ym_IFR)/std::pow(sigma_ym_IFR, 2);
            break;
        case 948:
            dJydy[0] = (-1.0*mym_JAK + 1.0*ym_JAK)/std::pow(sigma_ym_JAK, 2);
            break;
        case 949:
            dJydy[0] = (-1.0*mym_STAT1 + 1.0*ym_STAT1)/std::pow(sigma_ym_STAT1, 2);
            break;
        case 950:
            dJydy[0] = (-1.0*mym_SHP2 + 1.0*ym_SHP2)/std::pow(sigma_ym_SHP2, 2);
            break;
        case 951:
            dJydy[0] = (-1.0*mym_PPN + 1.0*ym_PPN)/std::pow(sigma_ym_PPN, 2);
            break;
        case 952:
            dJydy[0] = (-1.0*mym_PPX + 1.0*ym_PPX)/std::pow(sigma_ym_PPX, 2);
            break;
        case 953:
            dJydy[0] = (-1.0*mym_SOCS1 + 1.0*ym_SOCS1)/std::pow(sigma_ym_SOCS1, 2);
            break;
        case 954:
