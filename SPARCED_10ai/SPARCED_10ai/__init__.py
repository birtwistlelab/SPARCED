"""AMICI-generated module for model SPARCED_10ai"""

import amici

# Ensure we are binary-compatible, see #556
if '0.11.16' != amici.__version__:
    raise RuntimeError('Cannot use model SPARCED_10ai, generated with AMICI '
...
from SPARCED_10ai._SPARCED_10ai import *
