...
sources = ['swig/SPARCEDv6.i', *getModelSources()]
...
# Build shared object
model_module = Extension('SPARCEDv6._SPARCEDv6',
                         sources=sources,
                         ...
                         swig_opts=['-c++', '-modern', '-outdir', 'SPARCEDv6',
...
setup(
    name='SPARCEDv6',
    version='0.1.0',
    description='AMICI-generated module for model SPARCEDv6',
