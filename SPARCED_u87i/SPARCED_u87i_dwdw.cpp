...
#include "SPARCED_u87i_dwdw.h"

namespace amici {
namespace model_SPARCED_u87i {

void dwdw_SPARCED_u87i(realtype *dwdw, const realtype t, const realtype *x, const realtype *p, const realtype *k, const realtype *h, const realtype *w, const realtype *tcl){
