...
#include "SPARCED_10ai_dJydy.h"

namespace amici {
namespace model_SPARCED_10ai {

void dJydy_SPARCED_10ai(realtype *dJydy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my){
    switch(iy) {
        case 0:
