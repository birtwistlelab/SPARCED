...
void Jy_SPARCED_IFNg(realtype *Jy, const int iy, const realtype *p, const realtype *k, const realtype *y, const realtype *sigmay, const realtype *my){
    switch(iy) {
        case 0:
        ...
        case 772:
            ...
            break;
        case 773:
            Jy[0] = 0.5*std::log(2*amici::pi*std::pow(sigma_yIFR, 2)) + 0.5*std::pow(-myIFR + yIFR, 2)/std::pow(sigma_yIFR, 2);
            break;
        case 774:
            Jy[0] = 0.5*std::log(2*amici::pi*std::pow(sigma_yJAK, 2)) + 0.5*std::pow(-myJAK + yJAK, 2)/std::pow(sigma_yJAK, 2);
            break;
        case 775:
            Jy[0] = 0.5*std::log(2*amici::pi*std::pow(sigma_yRJ, 2)) + 0.5*std::pow(-myRJ + yRJ, 2)/std::pow(sigma_yRJ, 2);
            break;
        case 776:
            Jy[0] = 0.5*std::log(2*amici::pi*std::pow(sigma_yIFNRJ, 2)) + 0.5*std::pow(-myIFNRJ + yIFNRJ, 2)/std::pow(sigma_yIFNRJ, 2);
            break;
        case 777:
            Jy[0] = 0.5*std::log(2*amici::pi*std::pow(sigma_yIFNRJ2, 2)) + 0.5*std::pow(-myIFNRJ2 + yIFNRJ2, 2)/std::pow(sigma_yIFNRJ2, 2);
            break;
        case 778:
            Jy[0] = 0.5*std::log(2*amici::pi*std::pow(sigma_yIFNRJ2s, 2)) + 0.5*std::pow(-myIFNRJ2s + yIFNRJ2s, 2)/std::pow(sigma_yIFNRJ2s, 2);
            break;
        case 779:
            Jy[0] = 0.5*std::log(2*amici::pi*std::pow(sigma_ySTAT1, 2)) + 0.5*std::pow(-mySTAT1 + ySTAT1, 2)/std::pow(sigma_ySTAT1, 2);
            break;
        case 780:
            Jy[0] = 0.5*std::log(2*amici::pi*std::pow(sigma_yIFNRJ2s_STAT1, 2)) + 0.5*std::pow(-myIFNRJ2s_STAT1 + yIFNRJ2s_STAT1, 2)/std::pow(sigma_yIFNRJ2s_STAT1, 2);
            break;
        case 781:
            Jy[0] = 0.5*std::log(2*amici::pi*std::pow(sigma_ySTAT1s, 2)) + 0.5*std::pow(-mySTAT1s + ySTAT1s, 2)/std::pow(sigma_ySTAT1s, 2);
            break;
        case 782:
            Jy[0] = 0.5*std::log(2*amici::pi*std::pow(sigma_yIFNRJ2s_STAT1s, 2)) + 0.5*std::pow(-myIFNRJ2s_STAT1s + yIFNRJ2s_STAT1s, 2)/std::pow(sigma_yIFNRJ2s_STAT1s, 2);
            break;
        case 783:
            Jy[0] = 0.5*std::log(2*amici::pi*std::pow(sigma_ySTAT1s_STAT1s, 2)) + 0.5*std::pow(-mySTAT1s_STAT1s + ySTAT1s_STAT1s, 2)/std::pow(sigma_ySTAT1s_STAT1s, 2);
            break;
        case 784:
            Jy[0] = 0.5*std::log(2*amici::pi*std::pow(sigma_ySHP2, 2)) + 0.5*std::pow(-mySHP2 + ySHP2, 2)/std::pow(sigma_ySHP2, 2);
            break;
        case 785:
            Jy[0] = 0.5*std::log(2*amici::pi*std::pow(sigma_yIFNRJ2s_SHP2, 2)) + 0.5*std::pow(-myIFNRJ2s_SHP2 + yIFNRJ2s_SHP2, 2)/std::pow(sigma_yIFNRJ2s_SHP2, 2);
            break;
        case 786:
            Jy[0] = 0.5*std::log(2*amici::pi*std::pow(sigma_yPPX, 2)) + 0.5*std::pow(-myPPX + yPPX, 2)/std::pow(sigma_yPPX, 2);
            break;
        case 787:
            Jy[0] = 0.5*std::log(2*amici::pi*std::pow(sigma_ySTAT1s_PPX, 2)) + 0.5*std::pow(-mySTAT1s_PPX + ySTAT1s_PPX, 2)/std::pow(sigma_ySTAT1s_PPX, 2);
            break;
        case 788:
            Jy[0] = 0.5*std::log(2*amici::pi*std::pow(sigma_ySTAT1_STAT1s, 2)) + 0.5*std::pow(-mySTAT1_STAT1s + ySTAT1_STAT1s, 2)/std::pow(sigma_ySTAT1_STAT1s, 2);
            break;
        case 789:
            Jy[0] = 0.5*std::log(2*amici::pi*std::pow(sigma_ySTAT1snuc_STAT1snuc, 2)) + 0.5*std::pow(-mySTAT1snuc_STAT1snuc + ySTAT1snuc_STAT1snuc, 2)/std::pow(sigma_ySTAT1snuc_STAT1snuc, 2);
            break;
        case 790:
            Jy[0] = 0.5*std::log(2*amici::pi*std::pow(sigma_ySTAT1snuc, 2)) + 0.5*std::pow(-mySTAT1snuc + ySTAT1snuc, 2)/std::pow(sigma_ySTAT1snuc, 2);
            break;
        case 791:
            Jy[0] = 0.5*std::log(2*amici::pi*std::pow(sigma_yPPN, 2)) + 0.5*std::pow(-myPPN + yPPN, 2)/std::pow(sigma_yPPN, 2);
            break;
        case 792:
            Jy[0] = 0.5*std::log(2*amici::pi*std::pow(sigma_ySTAT1snuc_PPN, 2)) + 0.5*std::pow(-mySTAT1snuc_PPN + ySTAT1snuc_PPN, 2)/std::pow(sigma_ySTAT1snuc_PPN, 2);
            break;
        case 793:
            Jy[0] = 0.5*std::log(2*amici::pi*std::pow(sigma_ySTAT1nuc, 2)) + 0.5*std::pow(-mySTAT1nuc + ySTAT1nuc, 2)/std::pow(sigma_ySTAT1nuc, 2);
            break;
        case 794:
            Jy[0] = 0.5*std::log(2*amici::pi*std::pow(sigma_ySTAT1nuc_STAT1snuc, 2)) + 0.5*std::pow(-mySTAT1nuc_STAT1snuc + ySTAT1nuc_STAT1snuc, 2)/std::pow(sigma_ySTAT1nuc_STAT1snuc, 2);
            break;
        case 795:
            Jy[0] = 0.5*std::log(2*amici::pi*std::pow(sigma_ySOCS1, 2)) + 0.5*std::pow(-mySOCS1 + ySOCS1, 2)/std::pow(sigma_ySOCS1, 2);
            break;
        case 796:
            Jy[0] = 0.5*std::log(2*amici::pi*std::pow(sigma_yIFNRJ2s_SOCS1, 2)) + 0.5*std::pow(-myIFNRJ2s_SOCS1 + yIFNRJ2s_SOCS1, 2)/std::pow(sigma_yIFNRJ2s_SOCS1, 2);
            break;
        case 797:
            Jy[0] = 0.5*std::log(2*amici::pi*std::pow(sigma_yIFNRJ2s_SHP2_SOCS1_STAT1, 2)) + 0.5*std::pow(-myIFNRJ2s_SHP2_SOCS1_STAT1 + yIFNRJ2s_SHP2_SOCS1_STAT1, 2)/std::pow(sigma_yIFNRJ2s_SHP2_SOCS1_STAT1, 2);
            break;
        case 798:
            Jy[0] = 0.5*std::log(2*amici::pi*std::pow(sigma_ySTAT1s_STAT1s_PPX, 2)) + 0.5*std::pow(-mySTAT1s_STAT1s_PPX + ySTAT1s_STAT1s_PPX, 2)/std::pow(sigma_ySTAT1s_STAT1s_PPX, 2);
            break;
        case 799:
            Jy[0] = 0.5*std::log(2*amici::pi*std::pow(sigma_ySTAT1snuc_STAT1snuc_PPN, 2)) + 0.5*std::pow(-mySTAT1snuc_STAT1snuc_PPN + ySTAT1snuc_STAT1snuc_PPN, 2)/std::pow(sigma_ySTAT1snuc_STAT1snuc_PPN, 2);
            break;
        case 800:
            Jy[0] = 0.5*std::log(2*amici::pi*std::pow(sigma_yIFNRJ2s_SOCS1_STAT1, 2)) + 0.5*std::pow(-myIFNRJ2s_SOCS1_STAT1 + yIFNRJ2s_SOCS1_STAT1, 2)/std::pow(sigma_yIFNRJ2s_SOCS1_STAT1, 2);
            break;
        case 801:
            Jy[0] = 0.5*std::log(2*amici::pi*std::pow(sigma_yIFN, 2)) + 0.5*std::pow(-myIFN + yIFN, 2)/std::pow(sigma_yIFN, 2);
            break;
        case 802:
            Jy[0] = 0.5*std::log(2*amici::pi*std::pow(sigma_yIFNRJ2s_SHP2_STAT1, 2)) + 0.5*std::pow(-myIFNRJ2s_SHP2_STAT1 + yIFNRJ2s_SHP2_STAT1, 2)/std::pow(sigma_yIFNRJ2s_SHP2_STAT1, 2);
            break;
        case 803:
            Jy[0] = 0.5*std::log(2*amici::pi*std::pow(sigma_yIFNRJ2s_SHP2_SOCS1, 2)) + 0.5*std::pow(-myIFNRJ2s_SHP2_SOCS1 + yIFNRJ2s_SHP2_SOCS1, 2)/std::pow(sigma_yIFNRJ2s_SHP2_SOCS1, 2);
            break;
        case 804:
            Jy[0] = 0.5*std::log(2*amici::pi*std::pow(sigma_yIFNR, 2)) + 0.5*std::pow(-myIFNR + yIFNR, 2)/std::pow(sigma_yIFNR, 2);
            break;
        case 805:
        ...
        case 945:
            ...
            break;
        case 946:
            Jy[0] = 0.5*std::log(2*amici::pi*std::pow(sigma_ym_IFNG, 2)) + 0.5*std::pow(-mym_IFNG + ym_IFNG, 2)/std::pow(sigma_ym_IFNG, 2);
            break;
        case 947:
            Jy[0] = 0.5*std::log(2*amici::pi*std::pow(sigma_ym_IFR, 2)) + 0.5*std::pow(-mym_IFR + ym_IFR, 2)/std::pow(sigma_ym_IFR, 2);
            break;
        case 948:
            Jy[0] = 0.5*std::log(2*amici::pi*std::pow(sigma_ym_JAK, 2)) + 0.5*std::pow(-mym_JAK + ym_JAK, 2)/std::pow(sigma_ym_JAK, 2);
            break;
        case 949:
            Jy[0] = 0.5*std::log(2*amici::pi*std::pow(sigma_ym_STAT1, 2)) + 0.5*std::pow(-mym_STAT1 + ym_STAT1, 2)/std::pow(sigma_ym_STAT1, 2);
            break;
        case 950:
            Jy[0] = 0.5*std::log(2*amici::pi*std::pow(sigma_ym_SHP2, 2)) + 0.5*std::pow(-mym_SHP2 + ym_SHP2, 2)/std::pow(sigma_ym_SHP2, 2);
            break;
        case 951:
            Jy[0] = 0.5*std::log(2*amici::pi*std::pow(sigma_ym_PPN, 2)) + 0.5*std::pow(-mym_PPN + ym_PPN, 2)/std::pow(sigma_ym_PPN, 2);
            break;
        case 952:
            Jy[0] = 0.5*std::log(2*amici::pi*std::pow(sigma_ym_PPX, 2)) + 0.5*std::pow(-mym_PPX + ym_PPX, 2)/std::pow(sigma_ym_PPX, 2);
            break;
        case 953:
            Jy[0] = 0.5*std::log(2*amici::pi*std::pow(sigma_ym_SOCS1, 2)) + 0.5*std::pow(-mym_SOCS1 + ym_SOCS1, 2)/std::pow(sigma_ym_SOCS1, 2);
            break;
        case 954:
