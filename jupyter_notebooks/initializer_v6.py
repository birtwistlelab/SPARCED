...
# Step1_par_rxn = ['vA77','vA87','vC104','vbR','vbR','vdR','vD66']
# Step1_par_rxn = ['vbR','vbR','vdR','vD66','vC104','vA77','vA87']

# Step1_par_idx = [0,1,0,0,0,0,0]

# Step1_par_ids = [str(params_all.index[np.logical_and(params_all['rxn'].values==Step1_par_rxn[i], params_all['idx'].values==int(Step1_par_idx[i]))][0]) for i in range(len(Step1_par_rxn))]
...
kDDbasal_id = params_all.index[np.logical_and(params_all.rxn=='vD66',params_all.idx==0)][0]
